...
import com.misbahah.zikrdetails.ui.ZikrDetailsFragment

const val OPEN_AZKAR_PAGE_INDEX = 0
const val TIME_BOUND_AZKAR_PAGE_INDEX = 1
...
class CategoriesPagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
    ...
    private val tabFragmentsCreators: Map<Int, () -> Fragment> = mapOf(
        OPEN_AZKAR_PAGE_INDEX to { ZikrDetailsFragment() },
